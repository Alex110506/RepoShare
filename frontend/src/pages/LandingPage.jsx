  ...
  return (
    <div className="flex flex-col gap-6 px-4 md:px-16 lg:px-32 py-16">
        <div className="flex flex-col md:flex-row gap-6 items-stretch">
            <div className="flex-1 gap-6 bg-info-content hover:shadow-gray-600 hover:shadow-lg transition-shadow duration-300 rounded-xl p-8 text-center md:text-left flex flex-col items-start justify-center md:justify-start text-5xl md:text-7xl font-bold text-gray-900">
        ...
        <h1 className='font-bold text-primary-content text-4xl justify-self-center self-center'>
            Why RepoShare?
        </h1>
        <div className='flex flex-col md:flex-row justify-center gap-4'>
            <div className='flex flex-col gap-2 p-4 bg-base-300 rounded-xl'>
                <span className='text-3xl text-primary-content font-bold'>Share Projects</span>
                Upload and showcase your work with the student community
            </div>

            <div className='flex flex-col gap-2 p-4 bg-base-300 rounded-xl'>
                <span className='text-3xl text-primary-content font-bold'>Connect</span>
                Find teammates and collaborate on exciting projects
            </div>

            <div className='flex flex-col gap-2 p-4 bg-base-300 rounded-xl'>
                <span className='text-3xl text-primary-content font-bold'>Get Discovered</span>
        ...
        <div className='flex justify-center flex-col gap-4 items-center'>
            ...
            <Link to={"login"} className='btn p-7 bg-secondary px-12 text-2xl font-bold '>Login And Start Sharing</Link>
        </div>
    </div>
  )
}
